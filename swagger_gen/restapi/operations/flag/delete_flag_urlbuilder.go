...
func (o *DeleteFlagURL) Build() (*url.URL, error) { _ = "STUB: not implemented"; return nil, nil }

// Must is a helper function to panic when the url builder returns an error
func (o *DeleteFlagURL) Must(u *url.URL, err error) *url.URL { _ = "STUB: not implemented"; return nil }

// String returns the string representation of the path with query string
func (o *DeleteFlagURL) String() string { _ = "STUB: not implemented"; return "" }
