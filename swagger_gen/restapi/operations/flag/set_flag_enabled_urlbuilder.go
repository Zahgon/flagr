...
func (o *SetFlagEnabledURL) Build() (*url.URL, error) { _ = "STUB: not implemented"; return nil, nil }
...
func (o *SetFlagEnabledURL) String() string { _ = "STUB: not implemented"; return "" }
