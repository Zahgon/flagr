...
func (o *DeleteConstraintURL) Build() (*url.URL, error) { _ = "STUB: not implemented"; return nil, nil }
...
func (o *DeleteConstraintURL) String() string { _ = "STUB: not implemented"; return "" }
